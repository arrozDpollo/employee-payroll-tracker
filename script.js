...
const collectEmployees = function() {
  // Example prompt-based input collection
  ...
  while (addMore) {
    ...
    // Create an employee object and push it into the array
    employeesArray.push({
      firstName: firstName,
      lastName: lastName,
      salary: salary
    ...
    // Check if the user wants to add more employees
...
const getRandomEmployee = function(employeesArray) {
  ...
  alert(`Random Employee: ${randomEmployee.firstName} ${randomEmployee.lastName}, Salary: ${randomEmployee.salary.toLocaleString("en-US", {
    style: "currency",
    currency: "USD"
  })}`);
};
